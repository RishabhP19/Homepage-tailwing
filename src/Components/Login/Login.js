  ...
  return (
    <>
      ...
      <div className="mx-14 mt-10 md:w-1/2">
        ...
        <div className="mt-16 text-3xl font-bold">Sign In</div>
        ...
        <div className="flex ">
        <div  className="text-sm mt-4 font-semibold ">Don’t have an account?</div>
        <Link  className="mt-4 ml-2 text-sky-600 font-semibold" to="/SignUp">
        Sign Up
                </Link>
        </div>
